...
class Menu(arcade.View):
    def __init__(self):
        super().__init__()
        self.texture = arcade.load_texture("bg/mainbg.png")
    ...
    def on_draw(self):
        ...
        for i, name in enumerate(self.titles):
            ...
            arcade.draw_text(
                'Нажмите Enter, чтобы выбрать, нажмите Esc чтобы выйти.',
                10,
                10,
                arcade.color.BLACK,
                12,
    ...
    def on_key_press(self, key, modifiers):
        if key == arcade.key.LEFT:
            ...
            select_sound = arcade.load_sound("music/select.aac")
            ...
            if self.selected_index == 0:
                ...
                if music_player is not None:
                    ...
                    music_player = None
                    music_playing = False
                level1_view = lvl1.Level1(menu_view=self, volume=current_volume)
                level1_view.setup()
...
class Extras(arcade.View):
    def __init__(self, menu_view=None):
        super().__init__()
        self.menu_view = menu_view
        self.texture = arcade.load_texture("bg/black.jpg")
