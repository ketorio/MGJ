...
class Frupomo(arcade.Sprite):
    def __init__(self, image_file, scale):
        ...
        self.frupomoslice = arcade.load_texture("sprites/frupomoslice.png")
        self.frupomoslice_flipped = self.frupomoslice.flip_horizontally()
    ...
    def pomoslice(self):
        self.texture = self.frupomoslice

    def pomoslice_flipped(self):
        self.texture = self.frupomoslice_flipped
